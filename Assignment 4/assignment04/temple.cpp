...
//                       glm::vec3(-0.146291,0.195185,1.3214));
    ...
    cs4722::init_texture_from_file("../media/grass_texture_02.jpg", 1); // Change 1
    auto wrap_type = GL_MIRRORED_REPEAT;
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, wrap_type);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, wrap_type);

    cs4722::init_texture_from_file("../media/square-background-1456646_960_720.jpg", 2);
    cs4722::init_texture_from_file("../media/square-background-1456646_1024.png", 3);
    cs4722::init_texture_from_file("../media/square-background-1456650_960_720.jpg", 4);
    ...
    for(int x = 0; x < number; x++) {
        for(int y = 0; y < number; y++) {
            ...
            /*artf->surface_material.diffuse_color = cs4722::x11::steel_blue;
            artf->surface_material.diffuse_color.r = x * ca / (number-1) + cb;
            artf->surface_material.diffuse_color.g = y * ca / (number-1) + cb;
            artf->surface_material.diffuse_color.b = (x + y) * ca /(2*number-2) + cb;*/

            unsigned int red = (int) x * ca / (number-1) + cb;
    ...
    bl->texture_scale = number; //changed
    artf->the_shape = bl;
...
void MYmove_callback(GLFWwindow *window, double xpos, double ypos) {
...
//    cs4722::setup_debug_callbacks();
    ...
    glfwSetCursorPosCallback(window, MYmove_callback);
