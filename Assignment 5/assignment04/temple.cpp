...
static GLint u_transform = 7;
//static GLint u_vp_transform = 8;
static GLint u_n_transform = 9;
static GLint u_m_transform = 10;
static GLint u_sampler = 2;
static GLint u_surface_effect = 3;
static GLint u_diffuse_color = 4;
const static GLuint u_camera_position = 5;
const static GLuint u_samplerC = 6;
...
void render()
{
    ...
    for (auto artf : artifact_list) {
        ...
        //changes 6
        if(artf->surface_effect == 5 || artf->surface_effect == 6) {
